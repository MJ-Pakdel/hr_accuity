...
class ProblemDatabase:
    ...
    # CRUD helpers
    def list_problems(self, topic: Optional[str] = None, difficulty: Optional[int] = None) -> List[MathProblem]:
    ...
    def update_problem(self, problem_id: str, problem: MathProblem):
        with self._lock:
